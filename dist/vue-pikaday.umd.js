(function (global, factory) {
	...
	var script = {
	    ...
	    mounted: function mounted() {
	        this.pikaday = new pikaday(_extends({}, this.defaultSettings, this.defaultEventSettings, this.settings));
	    },
	    ...
	    computed: {
	        ...
	        defaultEventSettings: function defaultEventSettings() {
	            var _this = this;

	            return {
	                onSelect: function onSelect() {
	                    _this.$emit('input', _this.pikaday.toString());
	                }
	            };
	        }
	    }
	...
	var __vue_render__ = function __vue_render__() {
	  var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('input', { attrs: { "type": "text" }, domProps: { "value": _vm.value } });
	};
